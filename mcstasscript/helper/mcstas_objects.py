...
class Component:
    ...
    METADATA: dict(str, tuple(str, str))
        Extra unparsed metadata string(s) to be inserted in the compiled instrument
    ...
    append_METADATA(name: str, type: str, lines: str)
        Append the metadata `lines` to the dictionary for inclusion in the instrument file
    ...
    def __init__(self, instance_name, component_name, AT=None,
                 ...
                 JUMP=None, METADATA=None, SPLIT=None, comment=None, c_code_before=None,
                 c_code_after=None):
        """
        ...
        self.set_keyword_input(AT=AT, AT_RELATIVE=AT_RELATIVE, ROTATED=ROTATED,
                               ...
                               GROUP=GROUP, JUMP=JUMP, METADATA=METADATA, SPLIT=SPLIT,
    ...
    def set_keyword_input(self, AT=None, AT_RELATIVE=None, ROTATED=None,
                          ...
                          EXTEND=None, GROUP=None, JUMP=None, METADATA=None, SPLIT=None,
        ...
        if METADATA is not None:
            if isinstance(METADATA, dict):
                ...
                raise RuntimeWarning("Ignoring provided METADATA since it is not a dictionary")
    ...
    def append_METADATA(self, name: str, type: str, lines: str):
        self.METADATA[name] = type, lines
    ...
    def write_component(self, fo):
        ...
        if len(self.METADATA):
            for name, (type, lines) in self.METADATA.items():
                fo.write(f"METATDATA {type} {name} {{%\n{lines}\n%}}\n")
